...
infomation = ["N+I less than or equals to -121", "-121 less than N+I less than or equals to -120",
              "-120 less than N+I less than or equals to -119",
              " -119 less than N+I less than or equals to -118", "-118 less than N+I less than or equals to -117",
              "-117 less than N+I less than or equals to -116",
              "-116 less than N+I less than or equals to -115", "-115 less than N+I less than or equals to -114",
              " -114less than N+I less than or equals to -113",
              "-113 less than N+I less than or equals to -112", "-112 less than N+I less than or equals to -108",
              "-108 less than N+I less than or equals to -104",
              " UL Interference power is more than -104dbm", "UL Interference power is more than -100dbm",
              "UL Interference power is more than -96dbm",
...
moshellfile = r"/tmp/echiyua/" + r"configure/" + r"moshell_ip_owner_bak.txt"
...
def readfile():
    try:
        with open(moshellfile, 'r') as ff:
            ...
            for line in lines:
                line = line.strip()
                owner_list.append(line.strip().split("\t")[0])
                moshell_list.append(line.strip().split("\t")[1])
...
def analysis(result, version_result, moshell):
    ...
    if int(pmRadioUeRepCqi256QamRank1Distr[12]) > 20 or int(pmRadioUeRepCqi256QamRank1Distr[13]) or int(
            pmRadioUeRepCqi256QamRank1Distr[14]) \
            or int(pmRadioUeRepCqi256QamRank1Distr[15]):
        try:
            with open(file3, "a+") as f3:
                string = "FATAL:moshell:%s\t%s\t%s\t" % (moshell, owner_list[moshell_list.index(moshell)], version_result)
